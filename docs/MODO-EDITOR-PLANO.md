...
9. **Aula extra e linha extra são dado, não código.** Aula extra declara `nivel` (1–5) no próprio JSON e entra na trilha do nível; linha extra é ramo no PGN; abertura extra é arquivo novo (o índice nasce da varredura). Orçamento vira aviso com número; correção (lance ilegal, posição sem juiz — lance sem comentário deixou de ser erro em 17/9/2026) continua erro — **exceto a tablebase, ver 10**.
...
- ~~Afrouxar "todo lance nosso tem comentário"~~ — **feito em 17/9/2026, por decisão do Doug:** comentário é opcional em todo lance do move trainer, nos 11 repertórios.
